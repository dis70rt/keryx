...
async def simulated_mouse_move(page):
    """Simulate realistic, non-linear mouse movements on a Playwright page."""
...
async def human_scroll(page, max_scrolls=5):
    """Scrolls down page progressively to trigger lazy loading and mimic human reading."""
    try:
